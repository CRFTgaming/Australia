...
switch (_shop) do
{
	...
	case "rebel": {["Rebel Market",["water","apple","redgull","tbacon","lockpick","pickaxe","fuelF","peach","boltcutter","blastingcharge", "zipties","speedbomb","extacy","lsdx","methx","rso","bho","hash","heroinp","marijuana","cocainep"]]};
	...
	case "cop": {["Cop Item Shop",["handcuffs","handcuffkeys","donuts","coffee","spikeStrip","water","apple","redgull","fuelF","defusekit"]]};
